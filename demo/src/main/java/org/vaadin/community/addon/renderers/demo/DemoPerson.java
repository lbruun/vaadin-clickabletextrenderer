...
public class DemoPerson {
    ...
    public static Object[] getPropertyOrder() {
        return new Object[]{"id", "firstName", "surName", "company", "companyType", "city"};
    }
    ...
    public static Container.Indexed getDemoContainer() {
        ...
        return new BeanItemContainer(DemoPerson.class, personsList);
    }
